            ...
            <form role="form" method="post" action="prosestambah.php">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="table_number" placeholder="table number" name="table_number">
                  ...
                  <input type="number" class="form-control" id="price" placeholder="jumlah" name="qty">
