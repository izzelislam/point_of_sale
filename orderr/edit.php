...
<div class="col-md-6">
          ...
          <div class="box box-primary">
			...
			<?php 
				...
				$orderr=mysqli_fetch_assoc($result1);
			 ?>
            ...
            <form role="form" method="post" action="prosesedit.php">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="table_number" placeholder="table number" name="table_number" value="<?= $orderr['table_number'] ;?>">
                  <label>Pilih item</label>
                  <select class="form-control" name="item">
			                    <?php 
							$sql="SELECT * FROM item WHERE satus='1'";
							$result=mysqli_query($koneksi,$sql);
								while ($data=mysqli_fetch_assoc($result)) {

									if ($orderr['item_id'] == $data['id']) {
						 ?>
                  ...
                  <input type="number" class="form-control" id="price" placeholder="jumlah" name="qty" value="<?= $orderr['qty'] ;?>">
