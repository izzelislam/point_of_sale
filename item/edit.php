            ...
            <form role="form" method="post" action="prosesedit.php">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="item" placeholder="nama item" name="name" value="<?= $data1['nama'] ;?>">

                  <label for="price">price</label>
                  <input type="number" class="form-control" id="price" placeholder="price" name="price" value="<?= $data1['price'] ;?>">
                  ...
                  <select class="form-control" name="status">
                    <?php 
                     ...
                     ?>
                  <option value="<?= $data1['satus'] ;?>"><?= st($data1['satus']) ;?></option>

                  <option value="<?php echo s1($data1['satus']);?>"><?= s2($data1['satus']) ;?></option>
